    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_kwt') ? 'is-invalid' : '' }}" type="number" name="price_kwt" id="price_kwt" value="{{ old('price_kwt', $setting->price_kwt) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_th') ? 'is-invalid' : '' }}" type="number" name="price_th" id="price_th" value="{{ old('price_th', $setting->price_th) }}" step="0.000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profit_th') ? 'is-invalid' : '' }}" type="number" name="profit_th" id="profit_th" value="{{ old('profit_th', $setting->profit_th) }}" step="0.000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_th') ? 'is-invalid' : '' }}" type="number" name="max_th" id="max_th" value="{{ old('max_th', $setting->max_th) }}" step="0.000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ref') ? 'is-invalid' : '' }}" type="number" name="ref" id="ref" value="{{ old('ref', $setting->ref) }}" step="0.01">
                @if($errors->has('ref'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ref') }}
                    </div>
            ...
            {{-- <div class="form-group">
                <div class="form-check {{ $errors->has('proxy') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="proxy" id="proxy" value="1" {{ $setting->proxy || old('proxy', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="proxy">{{ trans('Proxy') }}</label>
                </div>
                @if($errors->has('proxy'))
                    <div class="invalid-feedback">
                        {{ $errors->first('proxy') }}
