...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.hardware-items.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label for="price">{{ trans('cruds.hardwareItem.fields.price') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hashrate') ? 'is-invalid' : '' }}" type="text" name="hashrate" id="hashrate" value="{{ old('hashrate', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profitability') ? 'is-invalid' : '' }}" type="text" name="profitability" id="profitability" value="{{ old('profitability', '') }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\HardwareItem::AVAILABLE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('available') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="available_{{ $key }}" name="available" value="{{ $key }}" {{ old('available', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('specification') ? 'is-invalid' : '' }}" name="specification" id="specification">{{ old('specification') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('coins') ? 'is-invalid' : '' }}" name="coins" id="coins">{{ old('coins') }}</textarea>
                @if($errors->has('coins'))
                    <div class="invalid-feedback">
                        {{ $errors->first('coins') }}
                    </div>
