...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-languageFaqs">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.faq.fields.language') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
@endcan
  ...
  let table = $('.datatable-languageFaqs:not(.ajaxTable)').DataTable({ buttons: dtButtons })
