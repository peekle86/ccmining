...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-userBalances">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.balance.fields.amount') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
@endcan
  ...
  let table = $('.datatable-userBalances:not(.ajaxTable)').DataTable({ buttons: dtButtons })
