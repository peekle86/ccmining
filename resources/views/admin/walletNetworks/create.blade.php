...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.walletNetwork.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.wallet-networks.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coingecko') ? 'is-invalid' : '' }}" type="text" name="coingecko" id="coingecko" value="{{ old('coingecko', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('in_usd') ? 'is-invalid' : '' }}" type="text" name="in_usd" id="in_usd" value="{{ old('in_usd', '') }}">
