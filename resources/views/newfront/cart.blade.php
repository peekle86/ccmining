                ...
                <button type="button"
                    ...
                    <svg width="158" height="56" viewBox="0 0 158 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g clip-path="url(#clip0_1565_11828)">
                            <path d="M134.513 16.6653L120.68 16.7129L121.099 42.0375L134.932 41.9899L134.513 16.6653Z"
                                  fill="#FF5F00"/>
                            <path
        ...
        <div class="flex-1">
            <div class="d-flex justify-content-center align-items-center">
                <button type="button"
                        ...
                        style="height: 60px">
                    <svg width="133" height="45" viewBox="0 0 115 38" fill="none" xmlns="http://www.w3.org/2000/svg">
