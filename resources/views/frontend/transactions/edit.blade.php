                    ...
                    <form method="POST" action="{{ route("frontend.transactions.update", [$transaction->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Transaction::TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ old('type', $transaction->type) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="amount" id="amount" value="{{ old('amount', $transaction->amount) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Transaction::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $transaction->status) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="source" id="source" value="{{ old('source', $transaction->source) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="target" id="target" value="{{ old('target', $transaction->target) }}">
