                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.settings.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price_kwt" id="price_kwt" value="{{ old('price_kwt', '') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price_mh" id="price_mh" value="{{ old('price_mh', '') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ref" id="ref" value="{{ old('ref', '') }}" step="0.01">
                            @if($errors->has('ref'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ref') }}
                                </div>
