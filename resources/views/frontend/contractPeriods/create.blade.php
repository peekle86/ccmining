    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contract-periods.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="period">{{ trans('cruds.contractPeriod.fields.period') }}</label>
                            <input class="form-control" type="number" name="period" id="period" value="{{ old('period', '') }}" step="1" required>
