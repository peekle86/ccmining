                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.currencies.update", [$currency->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="in_usd" id="in_usd" value="{{ old('in_usd', $currency->in_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="min_withdrawal" id="min_withdrawal" value="{{ old('min_withdrawal', $currency->min_withdrawal) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $currency->active || old('active', 0) === 1 ? 'checked' : '' }}>
