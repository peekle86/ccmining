                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contracts.update", [$contract->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $contract->amount) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="ended_at" id="ended_at" value="{{ old('ended_at', $contract->ended_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Contract::ACTIVE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="active_{{ $key }}" name="active" value="{{ $key }}" {{ old('active', $contract->active) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="percent" id="percent" value="{{ old('percent', $contract->percent) }}" step="0.01">
