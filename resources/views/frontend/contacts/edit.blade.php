                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contacts.update", [$contact->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="number" id="number" value="{{ old('number', $contact->number) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $contact->active || old('active', 0) === 1 ? 'checked' : '' }}>
