    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.hardware-items.update", [$hardwareItem->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="model">{{ trans('cruds.hardwareItem.fields.model') }}</label>
                            <input class="form-control" type="text" name="model" id="model" value="{{ old('model', $hardwareItem->model) }}" required>
                            @if($errors->has('model'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hashrate" id="hashrate" value="{{ old('hashrate', $hardwareItem->hashrate) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="power" id="power" value="{{ old('power', $hardwareItem->power) }}">
                            @if($errors->has('power'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('power') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="profitability" id="profitability" value="{{ old('profitability', $hardwareItem->profitability) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\HardwareItem::AVAILABLE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="available_{{ $key }}" name="available" value="{{ $key }}" {{ old('available', $hardwareItem->available) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $hardwareItem->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="specification" id="specification">{{ old('specification', $hardwareItem->specification) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="coins" id="coins">{{ old('coins', $hardwareItem->coins) }}</textarea>
                            @if($errors->has('coins'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('coins') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="script" id="script">{{ old('script', $hardwareItem->script) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="url" id="url" value="{{ old('url', $hardwareItem->url) }}" required>
                            @if($errors->has('url'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('url') }}
                                </div>
