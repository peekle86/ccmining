...
class FaqController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Faq::with(['category', 'language'])->select(sprintf('%s.*', (new Faq())->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'category', 'language']);
        ...
        return view('admin.faqs.index', compact('faq_categories', 'languages'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.faqs.create', compact('categories', 'languages'));
    }
    ...
    public function edit(Faq $faq)
    {
        ...
        $faq->load('category', 'language');

        return view('admin.faqs.edit', compact('categories', 'faq', 'languages'));
    }
